          ...
          <section>
            <div className='flex flex-col gap-5'>
              <div className='flex items-center gap-2'>
                <span>{userProfile?.username}</span>
                {
                  ...
                  <Button variant='secondary' className='bg-[#CBDCEB] text-gray-700 hover:[#DBE2EF]h-8 px-3 rounded-xl shadow-sm transition-all duration-150 mr-1'> Ad tools</Button>
                    ...
                    isFollowing ? (<>
                      <Button  className="bg-[#BCCCDC]  hover:bg-[#ED2B2A] text-white font-medium px-4 py-1 rounded-xl shadow-md transition duration-150">Unfollow</Button>
                      <Button  className="bg-[#BCCCDC]  hover:bg-blue-600 text-white font-medium px-4 py-1 rounded-xl shadow-md transition duration-150">Message</Button>
                      </>
                    ):
                    <Button  className="bg-blue-500 hover:bg-blue-600 text-white font-medium px-4 py-1 rounded-xl shadow-md transition duration-150">Follow</Button>
                  )
                }  
              </div>
              ...
              <div className='flex flex-col gap-1'>
                ...
                <Badge className='w-fit hover:bg-[#D4EBF8]' variant='secondary'><AtSign/><span className='pl-1'>{userProfile?.username}</span></Badge>
